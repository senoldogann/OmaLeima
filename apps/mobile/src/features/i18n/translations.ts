...
export const mobileTranslations: Record<AppLanguage, MobileCopy> = {
    ...
    auth: {
      ...
      googleButton: "Kirjaudu Googlella",
      ...
      onboardingSlides: [
        ...
        {
          key: "why-omaleima",
          eyebrow: "Miksi OmaLeima",
          title: "Haalarit pysyvät, paperikortti jää pois",
          body: "Näet leimat, palkinnot, kartan ja järjestäjän tiedotteet samasta paikasta koko illan ajan.",
        },
      ],
    ...
    student: {
      ...
      eventsTitle: "Approt",
      eventsMeta: "Löydä tulevat opiskelijaillat, liity mukaan ja seuraa missä leimat odottavat.",
    ...
    preferences: {
      ...
      appearanceBody: "Vaihda vaalean ja tumman teeman välillä.",
      languageTitle: "Kieli",
  ...
  en: {
    ...
    auth: {
      ...
      onboardingSlides: [
        ...
        {
          key: "why-omaleima",
          eyebrow: "Why OmaLeima",
          title: "Keep the haalarit energy, lose the paper card",
          body: "Track leimas, rewards, the venue map, and organizer updates from one place during the whole night.",
        },
      ],
