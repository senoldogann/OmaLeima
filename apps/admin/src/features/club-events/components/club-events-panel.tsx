...
const copyByLocale = {
  en: {
    ...
    activeMemberships: "Aktiiviset jäsenyydet",
    ...
    createDraftEvent: "Luo tapahtumaluonnos",
    createEvent: "Luo tapahtuma",
    createEventTab: "Luo tapahtuma",
    creating: "Luodaan...",
    creatableClubsBody: "Klubit, joille tämä tili voi luoda uusia tapahtumia juuri nyt.",
    creatableClubsLabel: "Luotavat klubit",
    description: "Kuvaus",
    end: "Päättyy",
    imagePreview: "Tapahtuman kansikuvan esikatselu",
    joinDeadline: "Ilmoittautumisen takaraja",
    manageEvent: "Hallinnoi tapahtumaa",
    manageEventsTab: "Hallinnoi tapahtumia",
    managedClubsBody: "Aktiiviset klubit, jotka näkyvät tässä järjestäjäsessiossa.",
    managedClubsLabel: "Hallittavat klubit",
    maxParticipants: "Osallistujamaksimi",
    membershipsBody: "Valitse oikea klubi ennen tapahtuman luontia, jos tämä tili hallinnoi useampaa yhteisöä.",
    ...
    newEventTitle: "Uusi klubitapahtuma",
    ...
    recentEvents: "Viimeisimmät tapahtumat",
    recentEventsBodyPrefix: "Näytetään viimeisimmät",
    recentEventsBodySuffix: "tapahtumaa, jotka ovat luettavissa tässä klubisessiossa.",
    recentEventsEmpty: "Klubitapahtumia ei vielä näy. Luo ensimmäinen luonnos aloittaaksesi työnkulun.",
    recentEventsTitle: "Viimeisimmät näkyvät klubitapahtumat",
    ...
    updateEventTitle: "Päivitä valittu tapahtuma",
    uploadCover: "Lataa kansikuva tietokoneelta",
    uploadingCover: "Ladataan kansikuvaa...",
    visibility: "Näkyvyys",
    visibleEventsBody: "Luonnokset, julkaistut, aktiiviset, päättyneet tai perutut tapahtumat, jotka RLS sallii lukea.",
