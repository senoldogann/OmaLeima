...
const commands = [
  {
    label: "apps/mobile build_and_run syntax",
    command: ["bash", "-n", "apps/mobile/script/build_and_run.sh"],
  },
  {
    label: "apps/mobile build_and_run help",
    command: ["bash", "apps/mobile/script/build_and_run.sh", "--help"],
  },
  {
