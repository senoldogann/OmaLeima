...
## Current Todos (Announcement Media Cards)

- [x] Start a dedicated feature branch.
- [x] Inspect admin announcement form/read model and mobile feed/popup rendering.
- [x] Add nullable announcement image URL migration.
- [x] Thread image URL through admin create/read/validation.
- [x] Thread image URL through mobile announcement feed and popup models.
