...
## Current Todos (Announcement Storage Upload)

- [x] Start a dedicated bugfix branch.
- [x] Inspect current announcement schema, mobile feed, and admin/club form.
- [x] Add announcement media storage bucket and RLS policies.
- [x] Add admin browser upload helper with file validation and public URL verification.
- [x] Add file upload controls to admin/club announcement form.
