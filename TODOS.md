...
## Current Todos (Media Upload And Scanner Audit)

- [x] Start a dedicated feature branch.
- [x] Inspect business/club/event media upload helpers and scanner event management logic.
- [x] Decode picker base64 upload bodies in the shared storage helper.
- [x] Request base64 from all native media pickers.
- [x] Auto-save club profile media uploads.
- [x] Reduce repeated broken remote cover prefetch warnings.
